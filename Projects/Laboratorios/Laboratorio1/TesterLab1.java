...
if (ok_sofar)
  v_9 = v_8.getValue() ;
if (ok_sofar)
  ok_sofar = new GetCuentasOrdenadas(v_1).doCall().checkResult(new String[][] { { v_3 }, { v_7 }, { v_9 }, { v_5 } }) ;
return ok_sofar ;
}
) ;
    }
...
if (ok_sofar)
  v_1 = v_0.getValue() ;
if (ok_sofar)
  ok_sofar = new BorrarCuenta(v_1,new String("xxxx_dineroB")).doCall().checkResult(new CuentaNoExisteExc()) ;
if (ok_sofar)
{
...
if (ok_sofar)
  ok_sofar = new RetirarDinero(v_1,v_5,new Integer(100)).doCall().checkResult(new InsuficienteSaldoExc()) ;
if (ok_sofar)
  ok_sofar = new GetCuentasOrdenadas(v_1).doCall().checkResult(new String[][] { { v_5 }, { v_7,v_3 } }) ;
if (ok_sofar)
  ok_sofar = new HacerTransferencia(v_1,v_5,v_7,new Integer(76)).doCall().checkResult(new InsuficienteSaldoExc()) ;
if (ok_sofar)
...
if (ok_sofar)
  ok_sofar = new GetCuentasOrdenadas(v_1).doCall().checkResult(new String[][] { { v_5 }, { v_3 }, { v_7 } }) ;
if (ok_sofar)
...
if (ok_sofar)
  v_5 = v_4.getValue() ;
if (ok_sofar)
  ok_sofar = new GetIdCuentas(v_1,new String("2222222")).doCall().checkResult(new es.upm.aedlib.indexedlist.ArrayIndexedList<String>(new String[] { v_5 })) ;
if (ok_sofar)
...
if (ok_sofar)
  ok_sofar = new HacerTransferencia(v_1,v_3,v_5,new Integer(656)).doCall().checkResult(new InsuficienteSaldoExc()) ;
if (ok_sofar)
...
if (ok_sofar)
  v_5 = v_4.getValue() ;
if (ok_sofar)
  ok_sofar = new HacerTransferencia(v_1,new String("xxxx_dineroB"),v_5,new Integer(558)).doCall().checkResult(new CuentaNoExisteExc()) ;
if (ok_sofar)
  ok_sofar = new HacerTransferencia(v_1,v_5,v_3,new Integer(11)).doCall().checkResult(null) ;
if (ok_sofar)
  ok_sofar = new HacerTransferencia(v_1,v_3,new String("xxxx_dineroB"),new Integer(827)).doCall().checkResult(new CuentaNoExisteExc()) ;
if (ok_sofar)
...
if (ok_sofar)
  ok_sofar = new HacerTransferencia(v_1,v_3,v_3,new Integer(622)).doCall().checkResult(new InsuficienteSaldoExc()) ;
if (ok_sofar)
...
if (ok_sofar)
  ok_sofar = new HacerTransferencia(v_1,v_3,v_5,new Integer(957)).doCall().checkResult(new InsuficienteSaldoExc()) ;
return ok_sofar ;
}
) ;
    }
...
if (ok_sofar)
  ok_sofar = new HacerTransferencia(v_1,v_5,v_3,new Integer(230)).doCall().checkResult(new InsuficienteSaldoExc()) ;
if (ok_sofar)
  ok_sofar = new GetIdCuentas(v_1,new String("2222222")).doCall().checkResult(new es.upm.aedlib.indexedlist.ArrayIndexedList<String>(new String[] { v_5 })) ;
if (ok_sofar)
...
if (ok_sofar)
  ok_sofar = new GetIdCuentas(v_1,new String("2222222")).doCall().checkResult(new es.upm.aedlib.indexedlist.ArrayIndexedList<String>(new String[] { v_5 })) ;
if (ok_sofar)
  ok_sofar = new HacerTransferencia(v_1,v_3,v_5,new Integer(344)).doCall().checkResult(new InsuficienteSaldoExc()) ;
if (ok_sofar)
...
if (ok_sofar)
  v_7 = v_6.getValue() ;
if (ok_sofar)
  ok_sofar = new GetIdCuentas(v_1,new String("1111111")).doCall().checkResult(new es.upm.aedlib.indexedlist.ArrayIndexedList<String>(new String[] { v_3,v_7 })) ;
if (ok_sofar)
{
...
if (ok_sofar)
  ok_sofar = new GetIdCuentas(v_1,new String("1111111")).doCall().checkResult(new es.upm.aedlib.indexedlist.ArrayIndexedList<String>(new String[] { v_3,v_7,v_9 })) ;
if (ok_sofar)
  ok_sofar = new GetCuentasOrdenadas(v_1).doCall().checkResult(new String[][] { { v_9 }, { v_7 }, { v_3 }, { v_5 } }) ;
if (ok_sofar)
  ok_sofar = new GetCuentasOrdenadas(v_1).doCall().checkResult(new String[][] { { v_9 }, { v_7 }, { v_3 }, { v_5 } }) ;
if (ok_sofar)
  ok_sofar = new HacerTransferencia(v_1,v_7,v_3,new Integer(733)).doCall().checkResult(new InsuficienteSaldoExc()) ;
if (ok_sofar)
  ok_sofar = new GetIdCuentas(v_1,new String("2222222")).doCall().checkResult(new es.upm.aedlib.indexedlist.ArrayIndexedList<String>(new String[] { v_5 })) ;
if (ok_sofar)
  ok_sofar = new HacerTransferencia(v_1,v_7,v_7,new Integer(132)).doCall().checkResult(new InsuficienteSaldoExc()) ;
if (ok_sofar)
  ok_sofar = new IngresarDinero(v_1,v_3,new Integer(0)).doCall().checkResult(new Integer(175)) ;
if (ok_sofar)
  ok_sofar = new HacerTransferencia(v_1,v_7,v_7,new Integer(641)).doCall().checkResult(new InsuficienteSaldoExc()) ;
return ok_sofar ;
}
) ;
    }
...
if (ok_sofar)
  ok_sofar = new GetIdCuentas(v_1,new String("1111111")).doCall().checkResult(new es.upm.aedlib.indexedlist.ArrayIndexedList<String>(new String[] { v_3,v_5,v_7 })) ;
if (ok_sofar)
...
if (ok_sofar)
  ok_sofar = new HacerTransferencia(v_1,v_5,v_3,new Integer(825)).doCall().checkResult(new InsuficienteSaldoExc()) ;
if (ok_sofar)
  ok_sofar = new HacerTransferencia(v_1,v_5,v_7,new Integer(677)).doCall().checkResult(new InsuficienteSaldoExc()) ;
if (ok_sofar)
...
if (ok_sofar)
  ok_sofar = new HacerTransferencia(v_1,v_5,v_3,new Integer(501)).doCall().checkResult(new InsuficienteSaldoExc()) ;
if (ok_sofar)
...
if (ok_sofar)
  ok_sofar = new RetirarDinero(v_1,v_5,new Integer(100)).doCall().checkResult(new Integer(0)) ;
if (ok_sofar)
  ok_sofar = new HacerTransferencia(v_1,v_5,v_7,new Integer(35)).doCall().checkResult(new InsuficienteSaldoExc()) ;
if (ok_sofar)
...
if (ok_sofar)
  ok_sofar = new RetirarDinero(v_1,v_9,new Integer(100)).doCall().checkResult(new InsuficienteSaldoExc()) ;
return ok_sofar ;
}
) ;
    }
...
if (ok_sofar)
  v_7 = v_6.getValue() ;
if (ok_sofar)
  ok_sofar = new GetIdCuentas(v_1,new String("1111111")).doCall().checkResult(new es.upm.aedlib.indexedlist.ArrayIndexedList<String>(new String[] { v_5,v_7 })) ;
return ok_sofar ;
}
) ;
    }
...
if (ok_sofar)
  ok_sofar = new RetirarDinero(v_1,v_3,new Integer(100)).doCall().checkResult(new InsuficienteSaldoExc()) ;
if (ok_sofar)
  ok_sofar = new HacerTransferencia(v_1,v_5,new String("xxxx_dineroB"),new Integer(701)).doCall().checkResult(new CuentaNoExisteExc()) ;
if (ok_sofar)
  ok_sofar = new IngresarDinero(v_1,v_5,new Integer(1000)).doCall().checkResult(new Integer(1000)) ;
if (ok_sofar)
...
if (ok_sofar)
  ok_sofar = new GetCuentasOrdenadas(v_1).doCall().checkResult(new String[][] { { v_3 }, { v_5 } }) ;
if (ok_sofar)
  ok_sofar = new HacerTransferencia(v_1,v_3,v_5,new Integer(175)).doCall().checkResult(new InsuficienteSaldoExc()) ;
if (ok_sofar)
  ok_sofar = new RetirarDinero(v_1,v_3,new Integer(100)).doCall().checkResult(new InsuficienteSaldoExc()) ;
if (ok_sofar)
...
if (ok_sofar)
  ok_sofar = new HacerTransferencia(v_1,v_3,v_3,new Integer(146)).doCall().checkResult(new InsuficienteSaldoExc()) ;
if (ok_sofar)
...
if (ok_sofar)
  v_7 = v_6.getValue() ;
if (ok_sofar)
  ok_sofar = new GetCuentasOrdenadas(v_1).doCall().checkResult(new String[][] { { v_7 }, { v_3 }, { v_5 } }) ;
if (ok_sofar)
  ok_sofar = new ConsultarSaldo(v_1,v_3).doCall().checkResult(new Integer(200)) ;
if (ok_sofar)
  ok_sofar = new HacerTransferencia(v_1,v_3,v_5,new Integer(704)).doCall().checkResult(new InsuficienteSaldoExc()) ;
if (ok_sofar)
  ok_sofar = new IngresarDinero(v_1,v_7,new Integer(1000)).doCall().checkResult(new Integer(1100)) ;
if (ok_sofar)
...
if (ok_sofar)
  ok_sofar = new ConsultarSaldo(v_1,v_7).doCall().checkResult(new Integer(1100)) ;
if (ok_sofar)
  ok_sofar = new GetIdCuentas(v_1,new String("2222222")).doCall().checkResult(new es.upm.aedlib.indexedlist.ArrayIndexedList<String>(new String[] { v_3,v_5,v_7 })) ;
if (ok_sofar)
...
if (ok_sofar)
  ok_sofar = new HacerTransferencia(v_1,v_3,v_7,new Integer(955)).doCall().checkResult(new InsuficienteSaldoExc()) ;
if (ok_sofar)
...
if (ok_sofar)
  ok_sofar = new GetIdCuentas(v_1,new String("1111111")).doCall().checkResult(new es.upm.aedlib.indexedlist.ArrayIndexedList<String>(new String[] { v_9 })) ;
if (ok_sofar)
...
if (ok_sofar)
  ok_sofar = new HacerTransferencia(v_1,v_3,v_3,new Integer(827)).doCall().checkResult(new InsuficienteSaldoExc()) ;
if (ok_sofar)
...
if (ok_sofar)
  ok_sofar = new HacerTransferencia(v_1,v_9,v_3,new Integer(165)).doCall().checkResult(new InsuficienteSaldoExc()) ;
if (ok_sofar)
...
if (ok_sofar)
  ok_sofar = new HacerTransferencia(v_1,v_5,v_3,new Integer(875)).doCall().checkResult(new InsuficienteSaldoExc()) ;
if (ok_sofar)
  ok_sofar = new GetIdCuentas(v_1,new String("1111111")).doCall().checkResult(new es.upm.aedlib.indexedlist.ArrayIndexedList<String>(new String[] { v_9 })) ;
if (ok_sofar)
  ok_sofar = new ConsultarSaldo(v_1,v_9).doCall().checkResult(new Integer(982)) ;
...
if (ok_sofar)
  ok_sofar = new GetIdCuentas(v_1,new String("2222222")).doCall().checkResult(new es.upm.aedlib.indexedlist.ArrayIndexedList<String>(new String[] { v_3,v_5,v_7 })) ;
if (ok_sofar)
  ok_sofar = new GetCuentasOrdenadas(v_1).doCall().checkResult(new String[][] { { v_9 }, { v_5 }, { v_7 }, { v_3 } }) ;
if (ok_sofar)
...
if (ok_sofar)
  ok_sofar = new ConsultarSaldo(v_1,v_3).doCall().checkResult(new Integer(1100)) ;
if (ok_sofar)
  ok_sofar = new HacerTransferencia(v_1,v_7,v_5,new Integer(808)).doCall().checkResult(new InsuficienteSaldoExc()) ;
if (ok_sofar)
...
if (ok_sofar)
  ok_sofar = new HacerTransferencia(v_1,v_5,v_3,new Integer(716)).doCall().checkResult(new InsuficienteSaldoExc()) ;
if (ok_sofar)
...
if (ok_sofar)
  ok_sofar = new ConsultarSaldo(v_1,v_3).doCall().checkResult(new Integer(1754)) ;
if (ok_sofar)
  ok_sofar = new HacerTransferencia(v_1,v_5,v_3,new Integer(876)).doCall().checkResult(new InsuficienteSaldoExc()) ;
if (ok_sofar)
...
if (ok_sofar)
  ok_sofar = new ConsultarSaldo(v_1,v_5).doCall().checkResult(new Integer(100)) ;
if (ok_sofar)
  ok_sofar = new HacerTransferencia(v_1,v_5,v_3,new Integer(441)).doCall().checkResult(new InsuficienteSaldoExc()) ;
if (ok_sofar)
  ok_sofar = new IngresarDinero(v_1,v_3,new Integer(1000)).doCall().checkResult(new Integer(1900)) ;
if (ok_sofar)
  ok_sofar = new ConsultarSaldo(v_1,v_5).doCall().checkResult(new Integer(100)) ;
...
if (ok_sofar)
  ok_sofar = new HacerTransferencia(v_1,v_5,v_5,new Integer(476)).doCall().checkResult(new InsuficienteSaldoExc()) ;
if (ok_sofar)
  ok_sofar = new HacerTransferencia(v_1,v_5,v_5,new Integer(689)).doCall().checkResult(new InsuficienteSaldoExc()) ;
if (ok_sofar)
  ok_sofar = new RetirarDinero(v_1,v_5,new Integer(100)).doCall().checkResult(new Integer(0)) ;
if (ok_sofar)
...
if (ok_sofar)
  v_7 = v_6.getValue() ;
if (ok_sofar)
  ok_sofar = new HacerTransferencia(v_1,v_7,v_3,new Integer(189)).doCall().checkResult(new InsuficienteSaldoExc()) ;
if (ok_sofar)
  ok_sofar = new HacerTransferencia(v_1,v_5,v_5,new Integer(83)).doCall().checkResult(new InsuficienteSaldoExc()) ;
if (ok_sofar)
...
if (ok_sofar)
  ok_sofar = new BorrarCuenta(v_1,v_3).doCall().checkResult(new CuentaNoVaciaExc()) ;
if (ok_sofar)
  ok_sofar = new GetCuentasOrdenadas(v_1).doCall().checkResult(new String[][] { { v_7,v_5 }, { v_3 } }) ;
return ok_sofar ;
}
) ;
    }
...
if (ok_sofar)
  ok_sofar = new HacerTransferencia(v_1,v_5,v_5,new Integer(708)).doCall().checkResult(new InsuficienteSaldoExc()) ;
if (ok_sofar)
  ok_sofar = new HacerTransferencia(v_1,v_3,v_3,new Integer(883)).doCall().checkResult(new InsuficienteSaldoExc()) ;
if (ok_sofar)
...
if (ok_sofar)
  ok_sofar = new ConsultarSaldo(v_1,v_5).doCall().checkResult(new Integer(270)) ;
if (ok_sofar)
  ok_sofar = new IngresarDinero(v_1,new String("xxxx_dineroB"),new Integer(1000)).doCall().checkResult(new CuentaNoExisteExc()) ;
if (ok_sofar)
  ok_sofar = new RetirarDinero(v_1,v_3,new Integer(100)).doCall().checkResult(new Integer(630)) ;
if (ok_sofar)
  ok_sofar = new HacerTransferencia(v_1,v_3,v_3,new Integer(793)).doCall().checkResult(new InsuficienteSaldoExc()) ;
if (ok_sofar)
...
if (ok_sofar)
  ok_sofar = new HacerTransferencia(v_1,v_3,v_3,new Integer(961)).doCall().checkResult(new InsuficienteSaldoExc()) ;
if (ok_sofar)
  ok_sofar = new ConsultarSaldo(v_1,v_3).doCall().checkResult(new Integer(691)) ;
if (ok_sofar)
  ok_sofar = new HacerTransferencia(v_1,v_5,new String("xxxx_dineroB"),new Integer(483)).doCall().checkResult(new CuentaNoExisteExc()) ;
if (ok_sofar)
...
if (ok_sofar)
  ok_sofar = new HacerTransferencia(v_1,v_3,new String("xxxx_dineroB"),new Integer(960)).doCall().checkResult(new CuentaNoExisteExc()) ;
if (ok_sofar)
